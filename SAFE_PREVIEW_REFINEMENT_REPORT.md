...
- `src/who-can-open-what.js`: owns allowed sections, safe fallbacks, and manager-as-employee behavior.
- `src/repair-saved-app-data.js`: repairs broken or older saved prototype data before screens use it.
- `src/dashboard-next-actions.jsx`: keeps role-safe dashboard action paths reusable and compact.
